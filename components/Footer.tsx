      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-slate-600">
            <a href="#offers" className="hover:text-slate-400 transition-colors">{t.nav.offers}</a>
            <a href="#games" className="hover:text-slate-400 transition-colors">{t.nav.games}</a>
            <a href="#academy" className="hover:text-slate-400 transition-colors">{t.nav.academy}</a>
