...
## Corpus Check
- 54 files · ~578,484 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 313 nodes · 464 edges · 23 communities (16 shown, 7 thin omitted)
...
Cohesion: 0.19
Nodes (13): CTABanner(), FAQ(), Hero(), LandingHeader(), sectionLinks, pillarIcons, Pillars(), Pricing() (+5 more)
