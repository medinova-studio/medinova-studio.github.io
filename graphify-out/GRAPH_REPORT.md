...
## Corpus Check
- 76 files · ~585,943 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 428 nodes · 683 edges · 25 communities (17 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa92bf74`
...
Cohesion: 0.09
Nodes (28): GameDevelopmentPage(), metadata, metadata, metadata, About(), buildSchema(), Contact(), FormValues (+20 more)
...
Cohesion: 0.05
Nodes (37): autoprefixer, eslint, eslint-config-next, next-sitemap, devDependencies, autoprefixer, eslint, eslint-config-next (+29 more)

### Community 5 - "jsonLd.ts"
Cohesion: 0.08
Nodes (29): AcademyPage(), AgencyPage(), inter, metadata, RootLayout(), spaceGrotesk, viewport, ACADEMY_HREFS (+21 more)

### Community 6 - "useLang"
Cohesion: 0.13
Nodes (23): metadata, AnnouncementBar(), Certification(), highlightIcons, Community(), featureIcons, FAQ(), Hero() (+15 more)
...
### Community 19 - "LanguageContext.tsx"
Cohesion: 0.11
Nodes (23): metadata, CTABanner(), FAQ(), Hero(), LandingHeader(), sectionLinks, pillarIcons, Pillars() (+15 more)
...
## Knowledge Gaps
- **211 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `lsp`, `runtime`, `alt` (+206 more)
...
- **Why does `useLang()` connect `useLang` to `Button.tsx`, `LanguageContext.tsx`, `jsonLd.ts`?**
