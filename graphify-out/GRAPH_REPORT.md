...
## Corpus Check
- 44 files · ~573,652 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 289 nodes · 385 edges · 24 communities (17 shown, 7 thin omitted)
...
- `Certification()` --calls--> `useLang()`  [EXTRACTED]
  components/academy/Certification.tsx → lib/LanguageContext.tsx
...
Cohesion: 0.11
Nodes (14): metadata, AnnouncementBar(), Certification(), highlightIcons, Community(), featureIcons, FAQ(), Hero() (+6 more)
...
Cohesion: 0.31
Nodes (7): FloatingWhatsApp(), formatPrice(), LEVEL_NAMES, Pricing(), ACADEMY_WHATSAPP_MESSAGE, ACADEMY_WHATSAPP_NUMBER, academyWhatsAppUrl()
...
## Knowledge Gaps
- **152 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `metadata`, `runtime`, `metadata` (+147 more)
...
- **Why does `useLang()` connect `useLang` to `LanguageContext.tsx`, `Pricing.tsx`, `academy/page.tsx`?**
